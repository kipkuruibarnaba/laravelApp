...
<div class="container border my-4" >
    ...
    <h4 class="text-center">Complete Trips between 8km to 15km</h4>
    <div class="row justify-content-center">
        <div class="col-md-8">

      @foreach ($decoded_data->trips as $key => $value) 
       {{-- @if($value->status =='COMPLETED' && $value->distance <'15' && $value->duration <'20')      --}}
       @if($value->status =='COMPLETED' && ($value->distance >='8' && $value->distance <'15') && ($value->duration >='10' && $value->duration <'20'))  
