...
<div class="container border my-4" >
    ...
    <div class="row justify-content-center">
      ...
      @foreach ($decoded_data->trips as $key => $value) 
       @if($value->status =='COMPLETED' && ($value->distance >='3' && $value->distance <'8') && ($value->duration >='5' && $value->duration <'10'))  
          
           {{-- @if($value->status =='COMPLETED' && ($value->distance >='3' && $value->distance <'15'))      --}}
