...
<div class="container border my-4" >
    ...
    <h4 class="text-center">Complete Trips above 15km</h4>
    <div class="row justify-content-center">
      ...
      <?php $__currentLoopData = $decoded_data->trips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
       <?php if($value->status =='COMPLETED' && $value->distance >'15' && $value->duration >'20'): ?>     
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMPP\htdocs\tripsproject\resources\views/distanceabove15kmcomplete.blade.php ENDPATH**/ ?>