...
<div class="container border my-4" >
    ...
    <h4 class="text-center">Complete and Cancelled Trips between 3km to 8km</h4>
    <div class="row justify-content-center">
      ...
      <?php $__currentLoopData = $decoded_data->trips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
       <?php if(($value->distance >='3' && $value->distance <'8') && ($value->duration >='5' && $value->duration <'10')): ?> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMPP\htdocs\tripsproject\resources\views/distanceunder8kmall.blade.php ENDPATH**/ ?>